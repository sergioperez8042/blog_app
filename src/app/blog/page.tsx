    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Descubre nuestro contenido sobre las últimas tendencias y desarrollos
        </p>
      </div>
      ...
      <div className={styles.content}>
        {filteredPosts.length > 0 ? (
          ...
          <div className={styles.noPosts}>
            <h3>No hay posts disponibles en esta categoría</h3>
            <p>Pronto agregaremos más contenido. ¡Vuelve pronto!</p>
          </div>
        )}
      </div>
    </div>
