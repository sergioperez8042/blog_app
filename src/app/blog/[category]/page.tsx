  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.headerContent}>
          <div className={styles.categoryInfo}>
            <h1 className={styles.title}>Categoría: {capitalizeFirst(categoryName)}</h1>
            <p className={styles.description}>
              Explora todos nuestros artículos de {categoryName.toLowerCase()}. 
              Contenido curado y generado por IA para mantenerte siempre actualizado.
            </p>
            <div className={styles.stats}>
              <span className={styles.postCount}>{posts.length} artículos disponibles</span>
            </div>
          </div>
      ...
      <div className={styles.content}>
        {posts.length === 0 ? (
          <div className={styles.noPosts}>
            <h2>No hay posts en esta categoría</h2>
      ...
      <div className={styles.navigation}>
        <Link href="/" className={styles.navButton}>← Inicio</Link>
